...
var fruits=[];
var position=[];
var fruitsGroup,fruitsImg;
var gameover,gameoverImg;
var score = 0;
var winner,winnerImg;
var chompSound,deathSound;
...
function preload(){
  ...
  winnerImg = loadImage("win.png");
  chompSound = loadSound("pacman_eatfruit.wav");
...
function setup() {
  ...
  for(var f = 400; f<1080; f = f+50){
    fruit = createSprite(f,510,20,20);
    fruit.addImage(fruitsImg);
    fruit.scale = 0.5;
    fruits.push(fruit);
    console.log(fruits);
  }
  ...
  for(var f = 160; f<290; f = f+50){
    ...
    fruits12.scale = 0.5;
    fruits.push(fruits12);
    console.log(fruits);
  }
  for(var f = 45; f<150; f = f+50){
    fruits13 = createSprite(f,510,20,20);
    fruits13.addImage(fruitsImg);
    fruits13.scale = 0.5;
    fruits.push(fruits13);
    console.log(fruits);
  }
  for(var f = 45; f<150; f = f+50){
    fruits14 = createSprite(f,460,20,20);
    fruits14.addImage(fruitsImg);
    fruits14.scale = 0.5;
    fruits.push(fruits14);
    console.log(fruits);
  }
...
function draw() {
  ...
  if(score >= 252){
    winner = createSprite(700,300,50,50)
